      ...
      <div className={styles.text}>
        ...
        <p className={styles.description}>
          <span className={styles.paragraph}>
            ...
            helps others (including me) to improve their lives. I'm working as a freelancer right now, so if you want to
            hire me, check the sections below. I'm always open to innovative ideas and solutions, so I think we're gonna
            get along. I always want my apps to be the best they can be, so even if something works but can be done
            better, I improve it! 😎 I started my blogging adventure by publishing translations on{" "}
