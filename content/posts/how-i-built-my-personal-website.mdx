...
isPublished: true,
isPopular: true,
excerpt: "Which technologies am I used? What made me start a blog? What do I plan on posting here? Answers are here ✨"
...
<div id="introduction">
  If you have the desire to create your own blog, you are probably surprised by the number of tools available to do so.
  After all, a day without a <Link href="https://dayssincelastjavascriptframework.com/">new js framework</Link> is a day
  lost.
</div>
...
For example, instead of just inserting an image, I'm able to include an interactive element on the page that the user can use.
...
But please read the project rules first, which you can find at <Link href="https://github.com/Bartek532/zagrodzki.me/CONTRIBUTING.md">CONTRIBUTING.md</Link>. Let's help each other while keeping our code clean and clear.
...
**<Link href="https://k71m98save8.typeform.com/to/JSD3pPmE">What would you like to read about?</Link>**
