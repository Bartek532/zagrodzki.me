...
<div id="introduction">
  Today we'll talk about feature, that everyone use almost every day. Copy, cut, paste, sounds familar to you? Here you
  can learn how to handle these events on the website, how to copy something directly from the code and many more.
  Finally, we'll create a custom copy button that you can see below. Ready? Let's go!
</div>

<CopyBtn textToCopy="Example text copied from zagrodzki.me/blog/using-clipboard-in-js" label="Click me to copy!" />
