...
<div id="introduction">
  Yeah, yeah, I know the name’s not the best. But the most important thing is the code! 😉 This is simple shop project,
  where you can select products, add them to basket and pay for them at the checkout. Simple, but quite good and with
...
<Image src="/img/projects/ecommerce-sofa/stack.png" alt="ecommerce shop tech stack" width="1200" height="880" />
...
<Image src="/img/projects/ecommerce-sofa/e2e-test.jpg" alt="ecommerce shop e2e test" width="1280" height="720" />
...
<Image src="/img/projects/ecommerce-sofa/basket.png" alt="ecommerce shop basket view" width="1200" height="880" />
