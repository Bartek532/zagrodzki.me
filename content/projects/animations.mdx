...
<div id="introduction">
  I always wanted to create a UI library, but my design skills, in short, didn't allow for it 😊 So I decided to create
  something as simple as possible. Smooth, short animations, whose code you can directly download and place on your
  site, this was my task.
</div>
...
<Image src="/img/projects/animations/stack-equation.png" alt="Tech stack equation" width="1200" height="880" />
...
<Image src="/img/projects/animations/preview.png" alt="Selected animation " width="1200" height="880" />
...
<Image src="/img/projects/animations/display.gif" alt="Animation preview" width="1120" height="888" />
