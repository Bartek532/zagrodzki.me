...
As you can see above I built two versions of _Book Searcher_. First, I tried to use MongoDB, Vuex and more... not quite the right technologies 😁 This project is still on my [Github](https://github.com/Bartek532/book-searcher-mongo), so you can see the code. When my app was growing up it turned out that I need relations, more control of my state, better validation, so I figured I'd use a different stack.
