export const allPositions = [
  {
    ...
    type: "Full-time",
    description:
      "Working on enterprise-level React applications for international clients. Focusing on delivering high-quality code while following best practices and modern development patterns. Collaborating closely with cross-functional teams to create scalable and maintainable solutions.",
