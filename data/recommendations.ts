export const allRecommendations = [
  {
    ...
    author: {
      ...
      position: "Software Engineer at Briza • CEO at Type Of Web",
  ...
  },
  {
    ...
    author: {
      name: "Szymon Hrabia",
      position: "Front-end Developer at AppUnite",
  ...
  },
  {
    ...
    author: {
      name: "Olaf Sulich",
      position: "Front-end Developer at AppUnite • CEO at Frontlive",
      image: "/img/references/olaf-sulich.png",
    },
  },
] as const;
